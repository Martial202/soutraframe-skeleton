                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-xl-6 col-sm-6 col-12">
                                        <div class="d-flex align-items-start border-right-blue-grey border-right-lighten-5">
                                            <span class="card-icon primary d-flex justify-content-center mr-3">
                                                <i class="feather icon-user-plus font-large-2 customize-icon font-large-2 p-1"></i>
                                            </span>
                                            <div class="stats-amount mr-3">
                                                <h3 class="heading-text text-bold-600"></h3>
                                                <p class="sub-heading">Nouvel Artisant</p>
                                            </div>
                                            <span class="inc-dec-percentage">
                                                <small class="success"><a href="<?=RACINE?>artisant/form"><i class="fa fa-plus"></i></a> </small>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xl-6 col-sm-6 col-12">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="stats-amount mr-3">
                                                ...
                                                <p class="sub-heading">Mes rapports</p>
                                            </div>
                                            <span class="inc-dec-percentage">
                                                <small class="danger"><a href="<?=RACINE?>rapport/list_agent"><i class="fa fa-eye"></i></a> </small>
                                            </span>
                                        </div>
                                    </div>
                                </div>
