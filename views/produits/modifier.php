            ...
            <section class="users-list-wrapper">
                            ...
                            <div class="card-header justify-content">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline">
                                        <span>
                                            <a href="<?= RACINE ?>produit/liste" class="btn btn-danger pull-right"> <?= Validator::ficon('list'); ?> faire un retour</a>
                                        </span>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="formEditProduit" method="POST">
                                <div class="row">
                                    <!-- Libelle Produit -->
                                    <div class="col-md-6 form-group">
                                        <label for="nom">Libelle Produit :</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="libelle_produit" name="libelle_produit" value="<?= $produits['libelle_produit'] ?>">
                                        </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="categorie_id" name="categorie_id">
                                                <?php if (!empty($produits['categorie_id'])) { ?>
                                                    <option value="<?= $produits['categorie_id']; ?>"><?= $libelle_categorie ?></option>
                                                <?php } else { ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="prix_produit" name="prix_produit" maxlength="10" value="<?= $produits['prix_produit'] ?>">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="qte_produit" name="qte_produit" value="<?= $produits['qte_produit'] ?>">
                                    ...
                                    <!-- Code produit -->
                                    <div class="col-md-4 hidden form-group">
                                        <label for="id_produit">Code Produit: </label>
                                        <div class="input-group">
                                            <input type="text" readonly value="<?= $produits['id_produit'] ?>" class="form-control" id="id_produit" name="id_produit">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea name="description_produit" class="form-control" id="description_produit"><?= htmlspecialchars($produits['description_produit']) ?></textarea>
                                    </div>
