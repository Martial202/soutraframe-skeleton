                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Liste des devis recentes</h4>
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body text-left w-100">
                                                        <h4 class="primary">Nouvelle Demande</h4>
                                                ...
                                                <div class=" mt-1 mb-0">
                                                    <a class="btn btn-primary" href="<?= RACINE; ?>devis/details/<?= $cryptedParams; ?>">Traiter le devis</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
