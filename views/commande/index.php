                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body text-left w-100">
                                                        <h4 class="primary">Nouvelle Commande</h4>
                                                        <span>Client: <b><?= $value['full_name_client'] ?></b></span><br>
                                                        <span>Telephone: <b><?= $value['telephone_client'] ?></b></span><br>
                                                        <span>Date: <b><?= $value['date_commande'] ?></b></span>
                                                    </div>
                                                </div>
                                                <div class=" mt-1 mb-0">
                                                    <a class="btn btn-success" href="<?= RACINE; ?>commande/details/<?= $cryptedParams; ?>">Traiter la commande</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
