                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Hoistorique
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-body">
            ...
            <section id="disable-print">
                ...
                <div class="row">
                    ...
                    // var_dump($rapports);
                    if ($oldlivraisons) {
                        foreach ($oldlivraisons as $value) {
                            $cryptedParams = $this->validator->crypter($value['id_livraison']);
                            $actions = $this->validator->getByElementItem("statut_livraison", "actions", "livraison_code", $value['code_livraison']);
                            $retVal = '';
                            if (isset($actions)) {
                                if ($actions == 1) {
                                    $retVal = '<h4 class="text-success">Livraison effectuée</h4>';
                                } elseif ($actions == 2) {
                                    $retVal = '<h4 class="text-danger">Livraison Annulée</h4>';
                                }
                            };
                    ?>
                                ...
                                <div class=" card">
                                    <div class="card-content ">
                                        <div class="card-body">
                                            ...
                                            <div class=" mt-1 mb-0">
                                                <a class="btn btn-secondary" href="<?= RACINE; ?>livraison/details/<?= $cryptedParams; ?>">Voir les details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
