...
class ModelDevis
{
    ...
    public function getDevisByEtats($id) // retourne les infos de la commande en fonction de l'id
    {
        try {
            $sql = 'SELECT * FROM devis WHERE etat_devis = ? ORDER BY date_created DESC';
    ...
    public function getDevisByIds($id) // retourne les infos de la commande en fonction de l'id
    {
        try {
    ...
    // {
    //     try {
    //         $sql = 'SELECT * FROM commandes WHERE etat_commande = ?';
    ...
    // {
    //     try {
    //         $sql = 'SELECT * FROM commandes WHERE etat_commande IN(?,?,?)';
